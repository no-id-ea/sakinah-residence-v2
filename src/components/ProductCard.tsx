...
const ProductCard = ({ title, description, children, href }: ProductCardProps) => {
  return (
    <div className="flex flex-col space-y-5">
      <Link href={href} className="relative group flex min-h-[600px] max-h-[700px] min-w-[300px] max-w-[400px] items-end justify-end bg-product-card rounded-[10px] bg-center bg-cover cursor-pointer transform scale-95 hover:scale-100 hover:brightness-125 transition-all ease-in duration-300">
