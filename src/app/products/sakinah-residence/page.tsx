...
export default function Product() {
  return (
    <>
      <ProductSwiper images={productImages.sakinah} />
      <Specification name="Sakinah Residence" brochure={brochures.sakinah} />
      <Calculator />
      <Denah />
      <ProductFacilities />
      <Siteplan siteplan={brochures.sakinah.siteplan} />
      <ProductLocation location={brochures.sakinah.location} />
    </>
  );
}
